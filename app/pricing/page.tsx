        ...
        <div className="max-w-7xl mx-auto">
          ...
          {selectedPlan !== null && (
            <div className="max-w-5xl mx-auto mb-16">
              <div className="bg-gradient-to-br from-orange-900/50 to-orange-800/40 rounded-2xl p-8 md:p-12 border border-orange-500/50 shadow-xl">
                <div className="flex items-start justify-between mb-8">
                  ...
                  <button
                    ...
                    className="text-orange-300 hover:text-white transition-colors p-2"
                  >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-4 text-orange-100">
                      ...
                      <div className="pt-4">
                        <button className="w-full px-8 py-4 rounded-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/25 transition-all text-lg">
